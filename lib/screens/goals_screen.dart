    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Container(
            margin:
                const EdgeInsets.only(left: 22, right: 19, top: 12, bottom: 4),
            child: Text(
              "Habits",
          ...
          Container(
            margin:
                const EdgeInsets.only(left: 22, right: 19, top: 10, bottom: 8),
            child: Text(
              "Goals",
              style: Theme.of(context).textTheme.headline1,
            ),
          ...
          Consumer<GoalList>(
            builder: (ctx, snapshot, child) {
              ...
              return StatefulBuilder(
                ...
                finalGoals.retainWhere((goal) => goal.enddate == selectedDate);
                    ...
                    Container(
                      ...
                      child: AnimatedList(
                          ...
                          itemBuilder:
                            ...
                            void removeItem(Key key, bool goal) {
                              _listKey.currentState!.removeItem(
                                  index,
                                  (context, animation) => GoalTile(
                                        key: key,
                              ...
                              Future.delayed(
                                  ...
                                  () => goal
                                      ? snapshot.completeGoal(tiles[index].key)
                                      : snapshot.completeMilestone(
                                          tiles[index].key,
                                          tiles[index].parentKey));
                            }
                            ...
                            if (tiles[index].runtimeType == Goal) {
                              return GoalTile(
                                ...
                                goal: true,
                                milestoneNumber: "",
                                repeat: tiles[index].repeat == 0 ? false : true,
                                reminder: tiles[index].reminder,
                                animation: animation,
                                helper: removeItem,
                              );
                            ...
                            int milestoneNumber = tiles[index].milestoneNumber;
